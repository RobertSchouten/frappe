...
def send(recipients=None, sender=None, subject=None, message=None, reference_doctype=None,
	...
	# add to queue
	add(recipients, sender, subject, email_content, email_text_context, reference_doctype,
...
def add(recipients, sender, subject, formatted, text_content=None,
	...
	cc=[], message_id=None, in_reply_to=None, send_after=None, send_priority=1, email_account=None, communication=None, unsubscribe_method=None, unsubscribe_params=None, expose_recipients=False):
	"""Add to Email Queue"""
	...
	try:
		mail = get_email(recipients, sender=sender, formatted=formatted, subject=subject,
			text_content=text_content, attachments=attachments, reply_to=reply_to, cc=cc, email_account=email_account, expose_recipients=expose_recipients)
